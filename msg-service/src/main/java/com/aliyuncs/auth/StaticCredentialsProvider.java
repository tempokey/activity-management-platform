...
/**
 * A container of legacy credential classes or a static credentials object For
...
public class StaticCredentialsProvider implements AlibabaCloudCredentialsProvider {
	...
	public StaticCredentialsProvider(IClientProfile clientProfile) {
		...
		if (null != legacyCredential.getSecurityToken()) {
			this.credentials = new BasicSessionCredentials(legacyCredential.getAccessKeyId(),
					legacyCredential.getAccessSecret(), legacyCredential.getSecurityToken());
		} else {
