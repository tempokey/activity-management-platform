...
public class ECSMetadataServiceCredentialsFetcher {
	...
	public InstanceProfileCredentials fetch() throws ClientException, JSONException {
	...
	public InstanceProfileCredentials fetch(int retryTimes) throws ClientException, JSONException {
